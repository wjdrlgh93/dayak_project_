...
"[project]/components/CommentSection.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function CommentSection({ boardId, myId }) {
    ...
    const load = ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$util$2f$boardApi$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getReplyList"])(boardId, 0).then((d)=>setReplies(d.content));
    ...
    const add = async ()=>{
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$util$2f$boardApi$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createReply"])(token, boardId, text).then(()=>{
            setText("");
            load();
        });
    };
    ...
    const remove = async (rid)=>{
        ...
        if (token && confirm("댓글을 삭제하시겠습니까?")) {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$util$2f$boardApi$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["deleteReply"])(token, rid).then(()=>load());
        }
    };
    // 수정 모드 진입
    ...
    const saveEdit = async (rid)=>{
        const token = localStorage.getItem("token");
        if (!token) return;
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$util$2f$boardApi$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["updateReply"])(token, rid, editText).then(()=>{
            setEditingId(null);
            load();
        });
    };
                    ...
                    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: editingId === r.id ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("textarea", {
...
"[project]/app/(site)/board/[id]/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$util$2f$boardApi$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/util/boardApi.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$CommentSection$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/CommentSection.tsx [app-ssr] (ecmascript)");
"use client";
;
;
;
...
function BoardDetailPage({ params }) {
    ...
    const [myId, setMyId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(0); // 🚀 내 아이디 상태 (초기값 0)
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        // 게시글 상세 정보 불러오기
        if (id) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$util$2f$boardApi$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getBoardDetail"])(id).then((data)=>{
                setBoard(data);
                setIsLoading(false);
            }).catch((err)=>{
    ...
    const handleDelete = async ()=>{
        if (confirm("정말 삭제하시겠습니까?")) {
            ...
            if (token && id) {
                try {
                    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$util$2f$boardApi$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["deleteBoard"])(token, id);
                    router.push("/board");
                } catch (error) {
                    alert("삭제에 실패했습니다.");
                }
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            myId === Number(board.userId) && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$CommentSection$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], {
                boardId: id,
                myId: myId
            }, void 0, false, {
                fileName: "[project]/app/(site)/board/[id]/page.tsx",
...
//# sourceMappingURL=_17f635e3._.js.map