...
function MedicationListPage() {
    ...
    const fetchMedications = async (token)=>{
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get('http://localhost:8080/api/medication/list', {
                headers: {
    ...
    const handleDelete = async (id)=>{
        ...
        const token = localStorage.getItem('token');
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].delete(`http://localhost:8080/api/medication/${id}`, {
                headers: {
                    Authorization: `Bearer ${token}`
                }
            });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__14feb7b6._.js.map