...
function SignupPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        //   alert("모든 필수 항목(닉네임 포함)을 입력해주세요.");
        //   return;
        // }
        try {
            ...
            if (response.ok) {
                ...
                // 상태 업데이트 -> 화면 리렌더링 -> 빨간 글씨 표시
                console.log("백엔드에서 받은 에러 데이터:", errorData);
                setErrors(errorData);
            }
        } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__cf39f562._.js.map