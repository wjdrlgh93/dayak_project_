...
"[project]/app/(site)/med/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$util$2f$drugApi$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/util/drugApi.ts [app-ssr] (ecmascript)"); // 위에서 만든 파일 import
"use client";
;
;
;
function DrugPage() {
    ...
    const handleSearch = async (e)=>{
        ...
        setMessage("검색 중입니다...");
        try {
            const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$util$2f$drugApi$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["searchDrugs"])(keyword);
            setDrugs(data);
...
//# sourceMappingURL=_ee017526._.js.map