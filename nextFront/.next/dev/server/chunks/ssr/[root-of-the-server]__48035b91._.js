...
function MyPage() {
    ...
    const fetchMember = async ()=>{
        ...
        try {
            // 도메인 생략, 헤더 자동 주입
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$util$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get('/api/member/detail');
    ...
    const handleUpdate = async ()=>{
        ...
        try {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$util$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].put('/api/member/update', formData);
            alert("성공적으로 수정되었습니다.");
            setEditMode(false);
            fetchMember(); // 갱신
        } catch (e) {
    ...
    const handleFileChange = async (e)=>{
        ...
        try {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$util$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post('/api/member/profileImg', uploadData);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__48035b91._.js.map