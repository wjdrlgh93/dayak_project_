    ...
    const fetchAllData = async (token)=>{
        try {
            const [medRes, recordRes] = await Promise.all([
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get('http://localhost:8080/api/medication/list', {
                    headers: {
                        Authorization: `Bearer ${token}`
                    }
                }),
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get('http://localhost:8080/api/medication/check/history', {
                    headers: {
                        Authorization: `Bearer ${token}`
                    }
                })
...
//# sourceMappingURL=app_%28site%29_medication_calender_page_tsx_6902498f._.js.map