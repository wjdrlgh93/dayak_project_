...
(()=>{
    const e = new Error("Cannot find module './pharmacy.css'");
...
function PharmacyPage() {
    ...
    const fetchPharmacies = async (pageNum)=>{
        try {
            setIsLoading(true);
            const response = await fetch(`http://localhost:8080/api/pharmacy/list?page=${pageNum}&size=200`);
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: pharmacies.map((item)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        onClick: ()=>window.open(`https://map.kakao.com/link/map/${item.hpid}`, "_blank"),
...
_s(PharmacyPage, "jYvJRbO/Aw9vhDN0DwECCcU6h8Q=");
_c = PharmacyPage;
var _c;
...
//# sourceMappingURL=_4cf25f83._.js.map